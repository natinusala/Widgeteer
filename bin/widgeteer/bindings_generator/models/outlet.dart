...
class Outlet {
  final List<OutletParameter> parameters;

  Outlet(this.parameters);
}

/// A parameter of an outlet call.
class OutletParameter {
  final String? label;
  final String name;
  final String type;

  OutletParameter(this.label, this.name, this.type);
}
